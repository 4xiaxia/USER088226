...
export type IconName = 'microphone' | 'camera' | 'bag' | 'arrow-left' | 'logout' | 'location' | 'play' | 'pause' | 'chat-bubble' | 'book-open' | 'price-tag' | 'user' | 'academic-cap' | 'document-chart-bar' | 'view-dashboard' | 'clock' | 'map' | 'navigation' | 'plus' | 'check-circle' | 'upload' | 'clipboard' | 'x' | 'sun' | 'moon' | 'calendar' | 'bell' | 'chevron-down' | 'home' | 'download' | 'folder-open' | 'trash' | 'pencil-alt';
...
const strokedIcons: Record<string, React.ReactElement> = {
  ...
  'download': <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M12 3v13.5M12 16.5l4.5-4.5M12 16.5l-4.5-4.5" />,
  'folder-open': <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 9.776c.112-.017.227-.026.344-.026h15.812c.117 0 .232.009.344.026m-16.5 0a2.25 2.25 0 00-1.883 2.542l.857 6a2.25 2.25 0 002.227 1.932H19.05a2.25 2.25 0 002.227-1.932l.857-6a2.25 2.25 0 00-1.883-2.542m-16.5 0V6A2.25 2.25 0 016 3.75h4.375L12 6h7.5a2.25 2.25 0 012.25 2.25v1.5m-16.5 0h16.5" />,
